...
Class_Potential_RxSM_MS_lagparams_nG_dT::Class_Potential_RxSM_MS_lagparams_nG_dT(
    const ISMConstants &smConstants)
    : Class_Potential_Origin(smConstants)
{
  Model         = ModelID::ModelIDs::RXSM_MS_LAGPARAMS_NG_DT;

  nPar = 6;   // number of parameters in the tree-Level Lagrangian AFTER using
               // tadpole equations
 ...
 */
std::vector<std::string> Class_Potential_RxSM_MS_lagparams_nG_dT::addLegendCT() const
{
 ...
 * input file
 */
std::vector<std::string> Class_Potential_RxSM_MS_lagparams_nG_dT::addLegendTemp() const
{
  std::vector<std::string> labels;
...
Class_Potential_RxSM_MS_lagparams_nG_dT::addLegendTripleCouplings() const
{
  std::vector<std::string> labels;
 ...
 */
std::vector<std::string> Class_Potential_RxSM_MS_lagparams_nG_dT::addLegendVEV() const
{
  std::vector<std::string> labels;
  // out = "Your VEV order"
  labels.push_back("wh");
 ...
 */
void Class_Potential_RxSM_MS_lagparams_nG_dT::ReadAndSet(const std::string &linestr,
 ...
 */
void Class_Potential_RxSM_MS_lagparams_nG_dT::set_gen(const std::vector<double> &par)
{
  ...
  scale = par[5]; // renormalisation scale is given as input
 ...
 */
void Class_Potential_RxSM_MS_lagparams_nG_dT::set_CT_Pot_Par(const std::vector<double> &par)
{
  dmh = par[0];
  dms = par[1];
  dLh = par[2];
 ...
 */
void Class_Potential_RxSM_MS_lagparams_nG_dT::write() const
{
  std::stringstream ss;
 ...
 */
std::vector<double> Class_Potential_RxSM_MS_lagparams_nG_dT::calc_CT() const
{
...
void Class_Potential_RxSM_MS_lagparams_nG_dT::TripleHiggsCouplings()
{
  if (!SetCurvatureDone) SetCurvatureArrays();
...
void Class_Potential_RxSM_MS_lagparams_nG_dT::SetCurvatureArrays()
{
  initVectors();
...
bool Class_Potential_RxSM_MS_lagparams_nG_dT::CalculateDebyeSimplified()
{
  return false;
  /*
...
bool Class_Potential_RxSM_MS_lagparams_nG_dT::CalculateDebyeGaugeSimplified()
{
  /*
...
double
Class_Potential_RxSM_MS_lagparams_nG_dT::VTreeSimplified(const std::vector<double> &v) const
{
...
double Class_Potential_RxSM_MS_lagparams_nG_dT::VCounterSimplified(
...
void Class_Potential_RxSM_MS_lagparams_nG_dT::Debugging(const std::vector<double> &input,
