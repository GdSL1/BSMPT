...
Class_Potential_RxSM_MS_lagparams::Class_Potential_RxSM_MS_lagparams(
    const ISMConstants &smConstants)
    : Class_Potential_Origin(smConstants)
{
  Model         = ModelID::ModelIDs::RXSM_MS_LAGPARAMS;
 ...
 */
std::vector<std::string> Class_Potential_RxSM_MS_lagparams::addLegendCT() const
{
 ...
 * input file
 */
std::vector<std::string> Class_Potential_RxSM_MS_lagparams::addLegendTemp() const
{
  std::vector<std::string> labels;
...
Class_Potential_RxSM_MS_lagparams::addLegendTripleCouplings() const
{
  std::vector<std::string> labels;
 ...
 */
std::vector<std::string> Class_Potential_RxSM_MS_lagparams::addLegendVEV() const
{
  std::vector<std::string> labels;
  // out = "Your VEV order"
  labels.push_back("wh");
 ...
 */
void Class_Potential_RxSM_MS_lagparams::ReadAndSet(const std::string &linestr,
 ...
 */
void Class_Potential_RxSM_MS_lagparams::set_gen(const std::vector<double> &par)
{
 ...
 */
void Class_Potential_RxSM_MS_lagparams::set_CT_Pot_Par(const std::vector<double> &par)
{
  dmh = par[0];
  dms = par[1];
  dLh = par[2];
 ...
 */
void Class_Potential_RxSM_MS_lagparams::write() const
{
  std::stringstream ss;
 ...
 */
std::vector<double> Class_Potential_RxSM_MS_lagparams::calc_CT() const
{
...
void Class_Potential_RxSM_MS_lagparams::TripleHiggsCouplings()
{
  if (!SetCurvatureDone) SetCurvatureArrays();
...
void Class_Potential_RxSM_MS_lagparams::SetCurvatureArrays()
{
  initVectors();
...
bool Class_Potential_RxSM_MS_lagparams::CalculateDebyeSimplified()
{
  return false;
  /*
...
bool Class_Potential_RxSM_MS_lagparams::CalculateDebyeGaugeSimplified()
{
  /*
...
double
Class_Potential_RxSM_MS_lagparams::VTreeSimplified(const std::vector<double> &v) const
{
...
double Class_Potential_RxSM_MS_lagparams::VCounterSimplified(
...
void Class_Potential_RxSM_MS_lagparams::Debugging(const std::vector<double> &input,
