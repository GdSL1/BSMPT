...
Class_Potential_RxSM_OS_lagparams_nG_ndT::Class_Potential_RxSM_OS_lagparams_nG_ndT(
    const ISMConstants &smConstants)
    : Class_Potential_Origin(smConstants)
{
  Model         = ModelID::ModelIDs::RXSM_OS_LAGPARAMS_NG_NDT;
 ...
 */
std::vector<std::string> Class_Potential_RxSM_OS_lagparams_nG_ndT::addLegendCT() const
{
 ...
 * input file
 */
std::vector<std::string> Class_Potential_RxSM_OS_lagparams_nG_ndT::addLegendTemp() const
{
  std::vector<std::string> labels;
...
Class_Potential_RxSM_OS_lagparams_nG_ndT::addLegendTripleCouplings() const
{
  std::vector<std::string> labels;
 ...
 */
std::vector<std::string> Class_Potential_RxSM_OS_lagparams_nG_ndT::addLegendVEV() const
{
  std::vector<std::string> labels;
  // out = "Your VEV order"
  labels.push_back("wh");
 ...
 */
void Class_Potential_RxSM_OS_lagparams_nG_ndT::ReadAndSet(const std::string &linestr,
 ...
 */
void Class_Potential_RxSM_OS_lagparams_nG_ndT::set_gen(const std::vector<double> &par)
{
 ...
 */
void Class_Potential_RxSM_OS_lagparams_nG_ndT::set_CT_Pot_Par(const std::vector<double> &par)
{
  dmh = par[0];
  dms = par[1];
  dLh = par[2];
 ...
 */
void Class_Potential_RxSM_OS_lagparams_nG_ndT::write() const
{
  std::stringstream ss;
 ...
 */
std::vector<double> Class_Potential_RxSM_OS_lagparams_nG_ndT::calc_CT() const
{
...
void Class_Potential_RxSM_OS_lagparams_nG_ndT::TripleHiggsCouplings()
{
  if (!SetCurvatureDone) SetCurvatureArrays();
...
void Class_Potential_RxSM_OS_lagparams_nG_ndT::SetCurvatureArrays()
{
  initVectors();
...
bool Class_Potential_RxSM_OS_lagparams_nG_ndT::CalculateDebyeSimplified()
{
  return false;
  /*
...
bool Class_Potential_RxSM_OS_lagparams_nG_ndT::CalculateDebyeGaugeSimplified()
{
  /*
...
double
Class_Potential_RxSM_OS_lagparams_nG_ndT::VTreeSimplified(const std::vector<double> &v) const
{
...
double Class_Potential_RxSM_OS_lagparams_nG_ndT::VCounterSimplified(
...
void Class_Potential_RxSM_OS_lagparams_nG_ndT::Debugging(const std::vector<double> &input,
