...
Class_Potential_RxSM_MS_lagparams_nG_dT_cts::Class_Potential_RxSM_MS_lagparams_nG_dT_cts(
 ...
 */
std::vector<std::string> Class_Potential_RxSM_MS_lagparams_nG_dT_cts::addLegendCT() const
{
 ...
 * input file
 */
std::vector<std::string> Class_Potential_RxSM_MS_lagparams_nG_dT_cts::addLegendTemp() const
{
  std::vector<std::string> labels;
...
Class_Potential_RxSM_MS_lagparams_nG_dT_cts::addLegendTripleCouplings() const
{
  std::vector<std::string> labels;
 ...
 */
std::vector<std::string> Class_Potential_RxSM_MS_lagparams_nG_dT_cts::addLegendVEV() const
{
  std::vector<std::string> labels;
  // out = "Your VEV order"
  labels.push_back("wh");
 ...
 */
void Class_Potential_RxSM_MS_lagparams_nG_dT_cts::ReadAndSet(const std::string &linestr,
 ...
 */
void Class_Potential_RxSM_MS_lagparams_nG_dT_cts::set_gen(const std::vector<double> &par)
{
 ...
 */
void Class_Potential_RxSM_MS_lagparams_nG_dT_cts::set_CT_Pot_Par(const std::vector<double> &par)
{
  dmh = par[0];
  dms = par[1];
  dLh = par[2];
 ...
 */
void Class_Potential_RxSM_MS_lagparams_nG_dT_cts::write() const
{
  std::stringstream ss;
 ...
 */
std::vector<double> Class_Potential_RxSM_MS_lagparams_nG_dT_cts::calc_CT() const
{
...
void Class_Potential_RxSM_MS_lagparams_nG_dT_cts::TripleHiggsCouplings()
{
  if (!SetCurvatureDone) SetCurvatureArrays();
...
void Class_Potential_RxSM_MS_lagparams_nG_dT_cts::SetCurvatureArrays()
{
  initVectors();
...
bool Class_Potential_RxSM_MS_lagparams_nG_dT_cts::CalculateDebyeSimplified()
{
  return false;
  /*
...
bool Class_Potential_RxSM_MS_lagparams_nG_dT_cts::CalculateDebyeGaugeSimplified()
{
  /*
...
double
Class_Potential_RxSM_MS_lagparams_nG_dT_cts::VTreeSimplified(const std::vector<double> &v) const
{
...
double Class_Potential_RxSM_MS_lagparams_nG_dT_cts::VCounterSimplified(
...
void Class_Potential_RxSM_MS_lagparams_nG_dT_cts::Debugging(const std::vector<double> &input,
