...
Class_Potential_RxSM_OS_physparams::Class_Potential_RxSM_OS_physparams(
    const ISMConstants &smConstants)
    : Class_Potential_Origin(smConstants)
{
  Model         = ModelID::ModelIDs::RXSM_OS_PHYSPARAMS;
 ...
 */
std::vector<std::string> Class_Potential_RxSM_OS_physparams::addLegendCT() const
{
 ...
 * input file
 */
std::vector<std::string> Class_Potential_RxSM_OS_physparams::addLegendTemp() const
{
  std::vector<std::string> labels;
...
Class_Potential_RxSM_OS_physparams::addLegendTripleCouplings() const
{
  std::vector<std::string> labels;
 ...
 */
std::vector<std::string> Class_Potential_RxSM_OS_physparams::addLegendVEV() const
{
  std::vector<std::string> labels;
  // out = "Your VEV order"
  labels.push_back("wh");
 ...
 */
void Class_Potential_RxSM_OS_physparams::ReadAndSet(const std::string &linestr,
 ...
 */
void Class_Potential_RxSM_OS_physparams::set_gen(const std::vector<double> &par)
{
 ...
 */
void Class_Potential_RxSM_OS_physparams::set_CT_Pot_Par(const std::vector<double> &par)
{
  dmh = par[0];
  dms = par[1];
  dLh = par[2];
 ...
 */
void Class_Potential_RxSM_OS_physparams::write() const
{
  std::stringstream ss;
 ...
 */
std::vector<double> Class_Potential_RxSM_OS_physparams::calc_CT() const
{
...
void Class_Potential_RxSM_OS_physparams::TripleHiggsCouplings()
{
  if (!SetCurvatureDone) SetCurvatureArrays();
...
void Class_Potential_RxSM_OS_physparams::SetCurvatureArrays()
{
  initVectors();
...
bool Class_Potential_RxSM_OS_physparams::CalculateDebyeSimplified()
{
  return false;
  /*
...
bool Class_Potential_RxSM_OS_physparams::CalculateDebyeGaugeSimplified()
{
  /*
...
double
Class_Potential_RxSM_OS_physparams::VTreeSimplified(const std::vector<double> &v) const
{
...
double Class_Potential_RxSM_OS_physparams::VCounterSimplified(
...
void Class_Potential_RxSM_OS_physparams::Debugging(const std::vector<double> &input,
