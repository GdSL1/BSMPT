...
VHiggs = -par[[1]]/2*C11 - par[[2]]/2*C22 + par[[3]]/24*C11^2 + par[[4]]/24*C22^2 + par[[5]]/2*C11*C22//Simplify
...
(*Define counterterms*)
parCT = {dmh,dms,dLh,dLs,dLhs} (*Join[Table[Symbol["d"<>ToString[p]],{p,par}], Table[Symbol["dT"<>ToString[i]],{i,Length[higgsbase]}]]*)
...
tiChoice = {Subscript[t, 1]->0,Subscript[t, 2]->0}
...
ImplementModel[
"RxSM_OS_physparams_nG_ndT", (*Model name*)
...
(*m1,m2,vh,vs,a*)
{125.25, 300, 246.22, 600, 0.20},(*Specific input parameters for the example file*)
