...
InputParameters={Lh,Ls,Lhs,vh,vs};
...
ImplementModel[
"RxSM_MS_lagparams_nG_dT", (*Model name*)
...
(*Lh,Ls,Lhs,vh,vs *)
{0.918, 0.618, 0.045, 246.22, 650},(*Specific input parameters for the example file*)
